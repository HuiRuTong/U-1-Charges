...
class PPO():
    ...
    def get_action_val(self, states, action_only=False, value_only=False, get_entropy=False):
        ...
        ret = (torch.stack((chosen_particle, chosen_generation, chosen_mod)),
    ...
    def upd(self, indices):
        ...
        for j in range(self.num_transitions // self.minibatch_size):
            ...
            _, new_log_probs, new_vals, entropy = self.get_action_val(self.states[indices[start:end]], get_entropy=True)
